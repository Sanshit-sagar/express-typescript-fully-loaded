...
const includeContact = (params: ParamsDictionary): boolean => params['contact'] && params['contact'] !== 'skip'
const includeHacker = (params: ParamsDictionary): boolean => params['hacker'] && params['hacker'] !== 'skip'
