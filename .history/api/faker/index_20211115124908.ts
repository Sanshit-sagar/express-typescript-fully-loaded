import express, { Request, Response, NextFunction, RequestParams } from 'express'
import {
    createUser,
    createContact,
    createAddress,
...
function assignContactDetails(params: RequestParams) {
...
/* /api/fake/phoney */
router.use(function(req: Request, res: Response, next: NextFunction) {
    if(assignContactDetails(req.params)) {
