...
const includesContact = (params: ParamsDictionary) => params['contact'] && params['contact'] !== 'skip'
const includesHacker = (params: ParamsDictionary) => params['hacker'] && params['hacker'] !== 'skip'
