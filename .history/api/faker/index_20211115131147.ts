...
const includeAddress = (params): boolean => params['address'] && params['address'] !== 'skip' 
const includeContact = (params): boolean => params['contact'] && params['contact'] !== 'skip'
const includeHacker = (params): boolean => params['hacker'] && params['hacker'] !== 'skip'

const sanitizeParams = (params): SkipDictionary => {
