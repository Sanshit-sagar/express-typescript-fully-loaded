...
const getUser() = (sluggableUsername: string) => {
    const slug = getSluggableUserName();
    const [firstName, lastName] = slugifyAndSplit(slug, 2);
...
router.get('/user/:userId', (req: Request, res: Response) => {
    const user = getUserFromSluggableUsername()
