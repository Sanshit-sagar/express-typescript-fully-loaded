...
import { PoserInput, PoserModel, GenderEnum } from '../models/poser.model'
import { ContactModel } from '../models/contact.model'
import { AddressModel } from '../models/address.model'

import { createAddress, createContact, createUser } from '../lib/faker/user'
 ...
 */
 const createPoser = async (req: Request, res: Response, next: NextFunction) => {
    ...
    const poserInput: PoserInput = {...createUser(), ...createAddress(), ...createContact() }
