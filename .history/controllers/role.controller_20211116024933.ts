...
/**
 * Create a new role 
 * @body name: Name of the new Role
 * @body description: Description of the new Role
 * @response 
 *  422: if body doesn't contain name and description
 *      - message: 
 *  201: if role is sucessfully created
 *  
 */
