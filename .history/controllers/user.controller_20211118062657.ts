...
const sanitizeSortableField = (dir): Direction => dir.length > 1  ? dir==='desc'  ? '-' : '+' : dir==='-' ? '-' : '+';
const sanitizeSortableField = (field: string) => 
const sanitizeDirection = (dir: InputDirection) => dir.length > 1  ? dir==='desc'  ? '-' : '+' : dir==='-' ? '-' : '+';
