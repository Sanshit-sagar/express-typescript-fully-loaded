...
const poserSchema = new Schema<PoserDocument>({
    ...
    userName: { 
        type: Schema.Types.String, required: true, index: true, unique: true },
    gender: { type: Schema.Types.String, enum: GenderEnum, default: GenderEnum.UNDEFINED, required: true },
