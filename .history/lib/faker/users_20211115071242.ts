...
const ADDRESS_GROUP_INDEX = 0; 
const HACKER_DETAILS_GROUP_INDEX = 1;
...
const collateUsers = (baseUsers: BaseUser[], allUsersProps: UserPropsInGroups[]): CollatedUser[] => {
    return baseUsers.map((baseUser, userIndex) => {
        return {
            ...baseUser,
            ...allUsersProps[ADDRESS_GROUP_INDEX][userIndex],
            ...allUsersProps[HACKER_DETAILS_GROUP_INDEX][userIndex]
        };
    });
}
