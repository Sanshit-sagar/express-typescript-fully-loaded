...
type UserWithAddress = BaseUser & Address; 
type UserWithHackerDetails = BaseUser & HackerDetails & Partial<Address>; 
type DeckedOutUserProfile = BaseUser & Partial<Address> & Partial<HackerDetails>
