...
const redirectionResponse: HttpResponseClass<Redirect>[] = [
...
const clientError: HttpResponseClass<ClientError>[] = [
...
const serverError: HttpResponseClass<ServerError>[] = [
