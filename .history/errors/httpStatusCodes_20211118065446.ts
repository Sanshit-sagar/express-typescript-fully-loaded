...
export type Informational = ConcatTriplet<Extract<ResponseClass, "1">, "0", "0" | "1" | "2" | "3">;
export type Success       = ConcatTriplet<Extract<ResponseClass, "2">, "0", Exclude<HttpStatusDigit, "9">> | "226";
export type Redirect      = ConcatTriplet<Extract<ResponseClass, "3">, "0", Exclude<HttpStatusDigit, "9">>; 
export type ClientError   = ConcatTriplet<Extract<ResponseClass, "4">, "0" | "1" | "2", HttpStatusDigit>   | "430" |"431";
export type ServerError   = ConcatTriplet<Extract<ResponseClass, "5">, "0", Exclude<HttpStatusDigit, "9">> | "510" |"511"; 
