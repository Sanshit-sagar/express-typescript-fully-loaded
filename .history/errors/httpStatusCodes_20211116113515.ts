...
type TwoXXResponse = `${Extract<ResponseClass, "2">}0${HttpStatusCodeDigit}` | "226";
type ThreeXXResponse = `${Extract<ResponseClass, "3">}0${HttpStatusCodeDigitumber}`;
type FourXXResponse = `${Extract<ResponseClass, "4">}${"0" | "1" | "2"}${number}` | "430" | "431" | "451"; 
type FiveXXResponse = `${Extract<ResponseClass, "5">}${"0"}${HttpStatusCodeDigit}` | "510" | "511"; 

const ac: TwoXXResponse = "209";
