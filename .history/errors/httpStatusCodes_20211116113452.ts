...
type ResponseSuffix = "1" | "2" | "3" | "4" | "5" | "6" | "7" | "8" | "9";
type OneXXResponse = `${Extract<ResponseClass, "1">}0${"0" | "1" | "2" | "3"}`;
type TwoXXResponse = `${Extract<ResponseClass, "2">}0${number}` | "226";
type ThreeXXResponse = `${Extract<ResponseClass, "3">}0${number}`;
type FourXXResponse = `${Extract<ResponseClass, "4">}${"0" | "1" | "2"}${number}` | "430" | "431" | "451"; 
type FiveXXResponse = `${Extract<ResponseClass, "5">}${"0"}${number}` | "510" | "511"; 
