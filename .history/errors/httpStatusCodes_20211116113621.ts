...
type ThreeXXResponse = `${Extract<ResponseClass, "3">}0${HttpStatusCodeDigit}`;
type FourXXResponse = `${Extract<ResponseClass, "4">}${"0" | "1" | "2"}${HttpStatusCodeDigit}` | "430" | "431" | "451"; 
type FiveXXResponse = `${Extract<ResponseClass, "5">}${"0"}${Exclude<HttpStatusCodeDigit, ""}` | "510" | "511"; 
type fxr = Exclude<FiveXXResponse, "509">;
