...
"errors":{
    ...
    "password":{
        ...
        "properties":{
            ...
            "type":"minlength",
            "minlength":8,
            "path":"password","value":"12837"},"kind":"minlength","path":"password","value":"12837"}},"_message":"User validation failed","name":"ValidationError","message":"User validation failed: email: Please enter a valid email address, password: A valid password requires between 8 and 20 characters"}
