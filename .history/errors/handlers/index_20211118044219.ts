...
{"errors":{"email":{"name":"ValidatorError","message":"Please enter a valid email address","properties":{"message":"Please enter a valid email address","type":"user defined","path":"email","value":"yeeeman"},"kind":"user defined","path":"email","value":"yeeeman"},"password":{"name":"ValidatorError","message":"A valid password requires between 8 and 20 characters","properties":{"message":"A valid password requires between 8 and 20 characters","type":"minlength","minlength":8,"path":"password","value":"12837"},"kind":"minlength","path":"password","value":"12837"}},"_message":"User validation failed","name":"ValidationError","message":"User validation failed: email: Please enter a valid email address, password: A valid password requires between 8 and 20 characters"}

type ValidatiorError = {
    name: string;
