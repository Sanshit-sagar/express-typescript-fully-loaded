...
const handleDuplicateKeyError = (error: ExtendedError, res: Response) => {
    const code = 409;
...
const handleValidationError = (error: ExtendedError, res: Response) => {
    let code = 400;
...
export default ((error: ExtendedError, req: Request, res: Response) => {
