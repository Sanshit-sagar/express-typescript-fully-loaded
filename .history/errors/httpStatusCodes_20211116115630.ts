...
export type ClientError = `${Extract<ResponseClass, "4">}${"0" | "1" | "2"}${HttpStatusCodeDigit}` | "430" | "431" | "451"; 
...
export const clientErrorResonses: HttpResponseClass<ClientError> = [
...
export const IanaHttpStatusCodes: HttpResponseClass<IanaHttpStatusCode> = [
