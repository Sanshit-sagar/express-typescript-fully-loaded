...
export type Informational = ZeroSplitCode<Extract<ResponseClass, "1">, "0", "0" | "1" | "2" | "3">;
export type Success       = ZeroSplitCode<Extract<ResponseClass, "2">, "0", Exclude<HttpStatusDigit, "9">> | "226";
